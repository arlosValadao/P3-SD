...
int mensagemRecebida(void* context, char* topicName, int topicLen, MQTTClient_message* message) {
    ...
    if(respostaMQTT == topicName){
        char varEnviar[100] = "";
        // Fazer pedido para Node 0x1 { 0xC3, 0xC5, 0xC1 }
        enviarMensagemMQTT(TOPICO, "0x1");
        delay(25);
        enviarMensagemMQTT(TOPICO, "0xC3");
        delay(25);
        varEnviar = "D1:", respostaMQTT, ",";
        enviarMensagemMQTT(TOPICO, "0xC5");
        delay(25);
        varEnviar = varEnviar + "D0:", respostaMQTT, ",";
        enviarMensagemMQTT(TOPICO, "0xC1");
        delay(25);
        varEnviar = varEnviar + "A0:", respostaMQTT, ",";
        enviarMensagemMQTT(TOPICO, "0x81");
        delay(25);

        // Fazer pedido para a Node 0x2
        enviarMensagemMQTT(TOPICO, "0x2");
        delay(25);
        enviarMensagemMQTT(TOPICO, "0xC3");
        delay(25);
        varEnviar = varEnviar + "D1:", respostaMQTT, ",";
        enviarMensagemMQTT(TOPICO, "0xC5");
        delay(25);
        varEnviar = varEnviar + "D0:", respostaMQTT, ",";
        enviarMensagemMQTT(TOPICO, "0xC1");
        delay(25);
        varEnviar = varEnviar + "A0:", respostaMQTT, ",";
        enviarMensagemMQTT(TOPICO, "0x82");
        delay(25);
